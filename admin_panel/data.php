          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover" >
                ...
                <tr >
                  <td>                     
                    <a href="article_edit.php?slug=<?= $news_row['slug']; ?>&action=update"><button type="button" class="btn btn-block btn-warning btn-sm"  >ویرایش</button></a>
                  ...
                  { echo 'label-success' ;}
                   ...
                   <?php if(($news_row['verify']) === 1) { echo 'تایید شده' ;}
                    ...
                    <td> <a href="actions/article_edit_action.php?slug=<?= $news_row['slug'];?>&action=verify"><button type="button" class="btn btn-block btn-success btn-sm">تایید</button></a></td>
                </tr>
