        ...
        <article class="box-10">
            ...
            <div class="row">
                <div class="col-12 col-md-6 social">
                    <ul>
                        <li class="fb"><a href="https://"><i class="fab fa-facebook-f"></i></a> </li>
        ...
        <section class="box box_1 web">
            <div class="col-12">
                ...
                <div class="row container_box">
                    <div class="row">
                    <?php while($article_row = $article_result_s->fetch_assoc()) { ?>
                ...
                <div class="row">
                    <div class="col-12 p-0">
                        <div class="most_viewed_news suggested">
                            <ul>
                                <?php while($article_row = $article_result_s2->fetch_assoc()) { ?>
                                    <li>
                                        <a href="show_news.php?article_slug=<?= $article_row['slug'] ?>">
                                            <?= $article_row['title'] ?>
                                        </a>
