...
$row_category = getArticleInListInIndex();
$most_comment = [];
$article = [];
            ...
            <div class="col-12 col-md-6">
                <section class="box">
                    <div id="carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <?php while($row_article_view3 = $article_result_rand->fetch_assoc()) { ?>
                ...
                <section>
                    <div id="media_news">
                        <div class="col-12">
                            <div class="row">
                            <?php while($row_article_view1 = $article_result_rand2->fetch_assoc()) {  ?>
                                <div class="col-6 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center text-md-right col-lg-7 p-md-1 p-lg-0">
                                            <div class="desc_news ">
                                                <h3>
                                                    <a href="show_news.php?article_slug=<?= $row_article_view1['slug'] ?>" target="_blank">ببینید | <?= $row_article_view1['title'] ?></a>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                ...
                <section class="box_news">
                    ...
                    <div class="tab-content">
                        <div id="box2" class="tab-pane active ">
                            <div class="row">
                            <?php while($row_article_view = $article_result_v->fetch_assoc()) {?>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="owl-carousel1 owl-carousel owl-theme">
                                        <?php while($article11__row = $article11__result4->fetch_assoc()) {?>
                                        <div class="item">
