...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 18, 2024 at 03:46 PM
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci;
...
(10, '2024-07-05 13:28:26', 'fhhfhhhfffffffffffffffffffffff', 'fffffffhhhhhhhhhhhhhhhhhhhhhhhhhhhh', 'ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', '3.jpg', 'r.ir', 12, 13, 14, 'fhhhhhhhhhhhh'),
(11, '2024-07-09 08:52:46', 'vghftgh', 'hhhhhhhhhhhhhhhhhhf', 'fgfgfgfgfgfgfgfgfgfgfgfgh', '1.jpg', 'gfdrtg', 3, 16, 2, 'gfn'),
(12, '2024-07-09 09:04:35', 'grfe', 'errrrrrrrrrrrrrrrrrrr', 'gggggggggggr', '3.jpg', 're', 12, 18, 13, 'f2nmp%6%Rx^9^rw4'),
(13, '2024-07-14 08:33:46', 'خبر۱ ', 'اتدلاتپدلادبل', 'ابلزتلا', 'img105.jpg', 'بل', 9, 12, 13, 'tQ0xGOz*%fyX@1Pa'),
(14, '2024-07-14 10:25:05', 'خبر۱', 'fg nbv', 'fnb ', 'img101.jpg', 'hgfb', 0, 11, 13, 'eGk_F#W&DBCmJb$E');
...
CREATE TABLE IF NOT EXISTS `categorys` (
  ...
  KEY `id` (`id`),
  KEY `id_2` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci;
...
(13, 'اصفهان', 10, 'trfghluivbgvkbjn\r\n'),
(15, 'خبرگان', 1, 'dfbj'),
(16, 'مسابقات', 2, 'gffffffffff'),
(17, 'ارز', 4, 'jjj'),
(18, 'انتخابات', 3, 'rfgbbbbbrdf'),
(20, 'تورم', 4, '%P*Qx(!1tuil)VAp'),
(26, 'gbd', 13, 'RvNT6aL2M%JmC^Dh'),
(27, 'gbfx', 24, 'SdMH1y3B0sv6%Q@I'),
(30, 'jklk', 28, 'mwL%%ETx9ok_MPSF'),
(32, 'k,k', 31, 'GIPDCZn7YBt4QX$J');
...
(11, 'ggf', 'f@gmail.com', 'hbnghmgh', '2024-07-18', 12, 1);
...
(1, 'Advertise_header', 'powerdeby.png', ''),
...
(6, 'Advertise_left3_index', '2.gif', 'zcsdcsdcvcyh'),
(7, 'Advertise_left4_index', '4.gif', ''),
...
(14, 'Advertise_right3_show_news', '5.gif', 'rrr'),
...
(15, 'سیاسی', '(Se_$0qhGzZDak5f'),
(19, 'ثقلابقل', '3SiWKj%ZJ^k#BD@o'),
(17, 'فرهنگی', 'ba94@&#^XqrYVhHm'),
(16, 'اقتصادی', 'i&4+!TEM5QjZD^3_'),
(14, 'خبر اینلاین', 'Nq)WEAi0uQKJ#aj2');
