            ...
            <section class="box ads">
                ...
                <div class="col-12 text-center p-0">
                    <a href="<?= $setting_row_right1['link']; ?>" target="_blank">
                        <img src="image/<?= $setting_row_right1['value_setting'] ?>" class="img-fluid w-100"  alt="<?= $setting_row_right1['value_setting'] ?>" title="<?= $setting_row_right1['value_setting'] ?>">
                    </a>
                </div>
                <div class="col-12 text-center p-0">
                    <a href="<?= $setting_row_right2['link']; ?>" target="_blank">
                        <img src="image/<?= $setting_row_right2['value_setting'] ?>" class="img-fluid w-100" alt="<?= $setting_row_right2['value_setting'] ?>" title="<?= $setting_row_right2['value_setting'] ?>">
                    </a>
                </div>
                <div class="col-12 text-center p-0">
                    <a href="<?= $setting_row_right3['link']; ?>" target="_blank">
                        <img src="image/<?= $setting_row_right3['value_setting'] ?>" class="img-fluid w-100" alt="<?= $setting_row_right3['value_setting'] ?>" title="<?= $setting_row_right3['value_setting'] ?>">
                    </a>
                </div>
                <div class="row">
